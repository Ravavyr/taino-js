class aboutLoader {
    constructor(site) {
        ...
        this.starthtml = `
            ...
            <p>
            We've created a framework based on vanilla javascript.
            </p>
            <h2>The reason for creating this:</h2>
            <p>
            Existing frameworks have tried to abstract away from core javascript far too much and from our point of view it is not necessary. 
